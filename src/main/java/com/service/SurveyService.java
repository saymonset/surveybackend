...
public class SurveyService {
    ...
    public SurveyDTO openAndSendToClientSurvey(@RequestParam String codigoEncuesta, @RequestParam String email, @RequestParam String lang, String codeCompany) {
        ...
        try {
            ...
            if (enc != null && sendSurvey != null) {
                String nameFile = enc.getFileEncuesta().substring(0, enc.getFileEncuesta().lastIndexOf("."));
                Resource resource = toJson.getResource(nameFile, lang, company);
                ...
                surveyDTO.setMessage("ENCUESTA_RESPONDIDA");
            }else if (enc==null){
                surveyDTO.setMessage("COMPANY_NO_EXISTE");
            }
        } catch (Exception e) {
//            //  surveyDTO.setMessage("Hola mundpopo");
                surveyDTO.setMessage(e.getMessage());
        }
        return surveyDTO;
    }
    ...
    public SurveyDTO procesar(Map<String, Object> response) {
        ...
        /**/
            ...
            surveyDTOResult.setMessage("THANKS");
            /**Fin Se calcula el nps y satisfaction general rating**/
        } catch (Exception e) {
            surveyDTOResult.setMessage(e.getMessage());
        }
